...
My research primarily addresses syntax and semantics, with my Ph.D. thesis titled `A Formal Grammar of Hindi` [you may read the [outline](/assets/pdf/thesis_outline.pdf) and [presentation](/assets/pdf/defenceppt_iitbhu.pdf) here]. The core objective of my doctoral work is to develop a formal grammar for Hindi, integrating propositional logic, predicate logic, type theory, and temporal logic. To support this endeavor, I have designed and implemented a Python-based parsing tool for the grammar. I am currently preparing for my final viva, which is scheduled to take place before March 2026.  
